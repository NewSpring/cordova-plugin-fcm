...
FCMPlugin.prototype.convertDynamicLink = function(path, success, error) {
  console.log("convertDynamicLink called");
  exec(success, error, "FCMPlugin", "convertDynamicLink", [path]);
};
